...
var calUtil = {
  ...
  ifToday : function(day, month, year){
    return this.ifSigned([new Date()], day, month, year);
  },
  // if is signed
  ...
  drawCal : function(iYear, iMonth ,signList) {
    ...
    htmls.push("<div class='"+classNext+"'><i class='fa fa-caret-right'></i></div>");
    htmls.push("<div class='"+classPrev+"'><i class='fa fa-caret-left'></i></div>");
    ...
    for (w = 1; w < 6; w++) {
      ...
      for (d = 0; d < 7; d++) {
        ...
        if(cell != empty){
          if(ifSigned){
            htmls.push("<td class='"+tdClass+"'><span><i class='fa fa-btc'></i></span></td>");
          }else{
          htmls.push("<td class='"+tdClass+"'><span class='bg'>"+cell+"</span></td>");
          }
        }else{
          htmls.push("<td class='"+tdClass+"'></td>");
        }
      }
      htmls.push("</tr>");
    }
