	...
	<div class="container">
		...
		<div class="member-info-group  row">
			<div class="member-info">
				<label>条码</label>
				<span class="list-input color-show">{{$code==null?'暂无':$code}}</span>
			</div>
		</div>
        <div class="member-info-group row">
			<div class="member-info">
				...
				<input  class="list-input color-show" value="{{$name==null?'暂无':$name}}" id="name">
			</div>
			<div class="member-info">
				<label>性别</label>
		...
		<div class="member-info-group  row phone">
			<div class="member-info" id="phone">
				<label>手机</label>
				<span class="list-input color-show">{{$mobile==null?'暂无':$mobile}}</span>
			</div>
		</div>
	</div>
@endsection
		...
		$(function () {
			$('#sex').mobiscroll().select({
				...
				onSelect: function (valueText, inst) {
                    $.ajax({
                        url: "/wechat/health/detection/{{$id}}/save_info",
                        type: 'POST',
            ...
            $("#phone").click(function(){
            	window.location.href="/wechat/health/detection/{{$good_code_id}}/{{$id}}/phone";
            })
		});
	</script>
@endsection