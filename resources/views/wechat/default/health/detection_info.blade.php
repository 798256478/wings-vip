...
@section('content')
    <div class="container">
        ...
        <div class="service-group row">
            <a class="service" href="/wechat/health/detection/questionnaire/{{$experiment_data['id']}}">
        ...
        <div class="service-group row">
            <a class="service" href="/wechat/health/detection/userInfo/{{$experiment_data['code']}}">
