...
class CustomerController extends Controller
{
	...
	public function userInfo(Request $request)
	{
		...
		$customerService = new CustomerService();
        $data['experiment_data_id'] = $request->route('experiment_data_id');
		$data['customer'] = $customerService->getUserBybarcodeid($barcode_id);
	...
	public function editPhone($barcode_id, $experiment_data_id){
		return $this->theme_view('health/detection_user_info_phone',['barcode_id'=>$barcode_id,'experiment_data_id'=>$experiment_data_id]);
	}

	public function putPhone(Request $request)
	{	
		$customerService = new CustomerService();
        $experiment_data_id = $request->input('experiment_data_id');
		...
		if($customerService->saveInfoByBarcodeId($barcode_id,['mobile'=>$data['mobile']])){
			return redirect('wechat/health/detection/userInfo/'. $barcode_id.'/'.$experiment_data_id );
		}
	}
