...
//            TODO 错误日志记录
            ...
            $eventExceptionRecord->statusCode = is_array($message) ? $message['http_code'] : '';
            $eventExceptionRecord->errors = is_array($message) ? $message['error_code'] : '';
//            $eventExceptionRecord->event = $event->string();
