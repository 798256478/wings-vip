    ...
    <div class="container">
        ...
        <div class="member-info-group row">
            <div class="member-info">
                ...
                <input id="password" class="list-input" placeholder="@if($card_info['password'])已设置@else未设置@endif">
            </div>
        </div>
        @if($card_info['mobile'])
            <div class="first">
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            $(".first .skip-button span").click(function(){
