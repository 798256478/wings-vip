...
//        Route::get('/newSuit/{suitId}/{amount}', 'OrderController@newSuitOrder');//新建套装订单
    ...
    Route::group(['prefix' => '/health'], function() {
        ...
        Route::get('/detection/{code}/userInfo', 'health\CustomerController@userInfo');
        Route::post('detection/{id}/save_info', 'health\CustomerController@saveInfo');
        Route::get('/detection/{code}/{id}/phone', 'health\CustomerController@editPhone');    //基因检测修改个人信息手机号编辑页
        ...
        Route::get('/detection/questionnaireAnswer/{experiment_data_id}', 'health\QuestionnaireController@showQuestionnaireAnswer');
        Route::get('/detection/questionnaire/{experiment_data_id}','health\QuestionnaireController@showQuestionnaire');
        Route::post('/detection/questionnaire/{experiment_data_id}', 'health\QuestionnaireController@saveQuestionnaireAnswer');
...
$api->version('v1', function ($api) {
    ...
    $api->group(['prefix' => '/api'], function($api){
        ...
        $api->get('/projectrisk', 'App\Http\Controllers\Api\Health\ConfigController@setProjectRisk');
        ...
        $api->post('/systemsync/receiveTest','App\Http\Controllers\Api\Yuda\SystemController@receiveTest');//内部模仿裕达接口测试
